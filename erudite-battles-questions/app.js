...
var getEnglishQuestion = function () {
...
var questions$1 = [];
questions$1.push({ title: 'How to calculate the sine of a right triange?', answers: ['Hypotenuse / Opposite', 'Opposite / Hypotenuse', 'Perpendicular / Opposite', 'Opposite / Hypotenuse'], correct: 1 });
questions$1.push({ title: 'What\'s the formula to for the volume of a Sphere?', answers: ['4/3 * PI * radious ^ 3', 'PI * radious ^ 2', 'PI * radious ^ 2 * height', 'Edge ^ 3'], correct: 0 });
questions$1.push({ title: 'Modus tollens means that', answers: ['¬ (P ^ Q) => ¬P v ¬Q', 'P -> Q, P is true then Q is too', 'P -> Q, Q is false then P is false', '¬¬P -> P'], correct: 2 });
questions$1.push({ title: 'What year Carl Friedrich Gauss was born?', answers: ['1236 AC', '1777 AC', '1200 BC', '1912 AC'], correct: 1 });
questions$1.push({ title: 'What is the derivative of a function?', answers: ['The domain of a function', 'The image of a function', 'Sensitivity to change of a function', 'The reflection of a function'], correct: 2 });
questions$1.push({ title: 'The median of 12, 5, 4 is', answers: ['5', '7', '12', '4'], correct: 0 });
questions$1.push({ title: 'The mean of 12, 5, 4 is', answers: ['5', '7', '12', '4'], correct: 2 });
questions$1.push({ title: 'What is nash equilibrium', answers: ['A game theory system', 'A formula to balance stadistics', 'An algebra formula', 'An engineer system'], correct: 0 });
questions$1.push({ title: 'log(8) is equal to', answers: ['2', '3', '4', '1'], correct: 1 });
questions$1.push({ title: 'The area of a square is', answers: ['side^2', '4 * side', 'lenth * width', '2 * side'], correct: 0 });
questions$1.push({ title: 'Area for a triangle', answers: ['2 * base * height', '1/2 * base * height', 'base * height / 4', 'base * height'], correct: 1 });
questions$1.push({ title: 'What is the mode', answers: ['The value that appears most often', 'The lowest value', 'The highest value', 'What Kardasains are wearing'], correct: 0 });
questions$1.push({ title: 'What\'s the derivative of a linear function a * x', answers: ['0', '1', 'a', 'x'], correct: 2 });
questions$1.push({ title: 'What\'s the derivative of x^2', answers: ['x', '2x', '2', '1'], correct: 1 });
var getMathQuestion = function () {
    var index = Math.floor(Math.random() * questions$1.length);
    var question = questions$1[index];
    questions$1.splice(index, 1);
    return question;
};
...
var EruditeBattlesQuestions = function (_Component) {
    inherits(EruditeBattlesQuestions, _Component);

    function EruditeBattlesQuestions() {
        classCallCheck(this, EruditeBattlesQuestions);

        var _this = possibleConstructorReturn(this, _Component.apply(this, arguments));

        _this.selectingQuestion = true;
        return _this;
    }

    EruditeBattlesQuestions.prototype.selectEnglish = function selectEnglish() {
        this.selectingQuestion = false;
        this.question = getEnglishQuestion();
    };

    EruditeBattlesQuestions.prototype.selectMath = function selectMath() {
        this.selectingQuestion = false;
        this.question = getMathQuestion();
    };

    EruditeBattlesQuestions.prototype.clearQuestion = function clearQuestion() {
        this.selectingQuestion = true;
        delete this.question;
    };

    return EruditeBattlesQuestions;
}(Component);

__decorate([tracked], EruditeBattlesQuestions.prototype, "selectingQuestion", void 0);
__decorate([tracked], EruditeBattlesQuestions.prototype, "question", void 0);

var __ui_components_erudite_battles_questions_template__ = { "id": "NLrH5nEj", "block": "{\"symbols\":[],\"statements\":[[6,\"div\"],[9,\"class\",\"container main-container\"],[7],[0,\"\\n\"],[4,\"if\",[[19,0,[\"selectingQuestion\"]]],null,{\"statements\":[[0,\"    \"],[6,\"button\"],[9,\"type\",\"button\"],[9,\"class\",\"btn btn-danger btn-lg btn-block theme-btn\"],[10,\"onclick\",[25,\"action\",[[19,0,[\"selectEnglish\"]]],null],null],[7],[0,\"English\"],[8],[0,\"\\n    \"],[6,\"button\"],[9,\"type\",\"button\"],[9,\"class\",\"btn btn-primary btn-lg btn-block theme-btn\"],[10,\"onclick\",[25,\"action\",[[19,0,[\"selectMath\"]]],null],null],[7],[0,\"Math\"],[8],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[0,\"    \"],[5,\"themed-question\",[],[[\"@question\",\"@clearQuestion\"],[[18,\"question\"],[25,\"action\",[[19,0,[\"clearQuestion\"]]],null]]],{\"statements\":[],\"parameters\":[]}],[0,\"\\n\"]],\"parameters\":[]}],[8],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "specifier": "template:/erudite-battles-questions/components/erudite-battles-questions" } };

var ThemedQuestion = function (_Component) {
    inherits(ThemedQuestion, _Component);

    function ThemedQuestion() {
        classCallCheck(this, ThemedQuestion);
    ...
    ThemedQuestion.prototype.didInsertElement = function didInsertElement() {
        var _this2 = this;

        window.setTimeout(function () {
            if (!_this2.questionAnswered) {
                alert('TIMEOUT!');
                _this2.args.clearQuestion();
            }
        }, 20000);
    };

    ThemedQuestion.prototype.selectAnswer = function selectAnswer(answer) {
...
var __ui_components_themed_question_template__ = { "id": "dyBJe76+", "block": "{\"symbols\":[\"answer\",\"index\",\"@question\"],\"statements\":[[6,\"div\"],[9,\"class\",\"row\"],[7],[0,\"\\n  \"],[6,\"div\"],[9,\"class\",\"col-12\"],[7],[0,\"\\n    \"],[6,\"div\"],[9,\"class\",\"panel panel-default\"],[7],[0,\"\\n      \"],[6,\"div\"],[9,\"class\",\"panel-body\"],[7],[0,\"\\n        \"],[6,\"h1\"],[9,\"class\",\"text-center\"],[7],[1,[19,3,[\"title\"]],false],[8],[0,\"\\n      \"],[8],[0,\"\\n    \"],[8],[0,\"\\n\\n  \"],[8],[0,\"\\n\"],[4,\"each\",[[19,3,[\"answers\"]]],[[\"key\"],[\"@index\"]],{\"statements\":[[0,\"  \"],[6,\"div\"],[9,\"class\",\"col-12\"],[7],[0,\"\\n    \"],[6,\"button\"],[9,\"type\",\"button\"],[9,\"class\",\"btn btn-primary btn-lg btn-block btn-question\"],[10,\"onclick\",[25,\"action\",[[19,0,[\"selectAnswer\"]],[19,2,[]]],null],null],[7],[1,[19,1,[]],false],[8],[0,\"\\n  \"],[8],[0,\"\\n\"]],\"parameters\":[1,2]},null],[8],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "specifier": "template:/erudite-battles-questions/components/themed-question" } };

var moduleMap = { 'component:/erudite-battles-questions/components/erudite-battles-questions': EruditeBattlesQuestions, 'component:/erudite-battles-questions/components/erudite-battles-questions/get-english-question': getEnglishQuestion, 'component:/erudite-battles-questions/components/erudite-battles-questions/get-math-question': getMathQuestion, 'template:/erudite-battles-questions/components/erudite-battles-questions': __ui_components_erudite_battles_questions_template__, 'component:/erudite-battles-questions/components/themed-question': ThemedQuestion, 'template:/erudite-battles-questions/components/themed-question': __ui_components_themed_question_template__ };

var resolverConfiguration = { "app": { "name": "erudite-battles-questions", "rootName": "erudite-battles-questions" }, "types": { "application": { "definitiveCollection": "main" }, "component": { "definitiveCollection": "components" }, "helper": { "definitiveCollection": "components" }, "renderer": { "definitiveCollection": "main" }, "template": { "definitiveCollection": "components" } }, "collections": { "main": { "types": ["application", "renderer"] }, "components": { "group": "ui", "types": ["component", "template", "helper"], "defaultType": "component", "privateCollections": ["utils"] }, "styles": { "group": "ui", "unresolvable": true }, "utils": { "unresolvable": true } } };
